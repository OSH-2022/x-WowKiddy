...
#    subprocess.Popen(["juicefs", "mount", redisUrl, mountPointNoSlash,"-v"], shell=True)
    subprocess.Popen("juicefs mount redis://irisesd:DCchengding2003@disgrafs.redis.rds.aliyuncs.com:6379/1 X:  --writeback", shell=True)
